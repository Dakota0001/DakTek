...
function EFFECT:Render()
	...
	if self.size>0.80 then
		render.DrawBeam( self.Startpos, self.Endpos, (1-self.size)*57.142, 0, 0.5, Color( 255, 175, 0, 255 ) ) 
	end
	if self.size<=0.80 and self.size>0.7 then
		render.DrawBeam( self.Startpos, self.Endpos, ((self.size))*14.256, 0, 0.5, Color( 255, 175, 0, 255 ) ) 
	end
	if self.size<=0.70 and self.size>=0.2 then
		render.DrawBeam( self.Startpos, self.Endpos, 10, 0, 0.5, Color( 255, 175, 0, 255 ) ) 
	end
	if self.size<0.2 then
		render.DrawBeam( self.Startpos, self.Endpos, self.size*50, 0, 0.5, Color( 255, 175, 0, 255 ) ) 
	end
end