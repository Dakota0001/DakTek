...
function EFFECT:Init( data )
	...
	for i = 1,4 do
		...
		if (particle) then
			...
			particle:SetStartSize(8.1770124937832) 
			particle:SetEndSize(2.1805128579091)
	...
	for i=1, 1 do
		...
		if (Debris) then
			Debris:SetVelocity (Vector(math.random(-50,50),math.random(-50,50),math.random(-50,50)))
	...
	Sparks:SetMagnitude( math.Rand(0.1,0.1) )
	Sparks:SetScale( math.Rand(0.5,1.5) )
	Sparks:SetRadius( math.Rand(5,5) )
