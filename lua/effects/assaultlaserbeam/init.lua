...
function EFFECT:Render()
	...
	if self.size>0.80 then
		render.DrawBeam( self.Startpos, self.Endpos, (1-self.size)*114.284, 0, 0.5, Color( 255, 255, 255, 255 ) ) 
	end
	if self.size<=0.80 and self.size>0.7 then
		render.DrawBeam( self.Startpos, self.Endpos, ((self.size))*28.512, 0, 0.5, Color( 255, 255, 255, 255 ) ) 
	end
	if self.size<=0.70 and self.size>=0.2 then
		render.DrawBeam( self.Startpos, self.Endpos, 20, 0, 0.5, Color( 255, 255, 255, 255 ) ) 
	end
