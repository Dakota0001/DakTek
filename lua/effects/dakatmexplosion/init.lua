...
function EFFECT:Init( data )
	...
	for i = 1,125 do
		...
		local particle = emitter:Add( "dak/smokey", Pos + Vector( math.random(-125,125),math.random(-125,125),math.random(-125,125) ) ) 
...
for i = 1,125 do
		...
		local particle = emitter:Add( "dak/flamelet5", Pos + Vector( math.random(-75,75),math.random(-75,75),math.random(-75,75) ) ) 
