...
function EFFECT:Init( data )
	...
	for i = 1,1 do
		...
		if (particle) then
			...
			local CVal = math.random(0,25)
			particle:SetColor(CVal,CVal,CVal,math.random(150,250))
	...
	for i = 1,1 do
		...
		if (particle) then
			...
			particle:SetAngleVelocity( Angle(0,0,0) ) 
			particle:SetRoll(math.Rand( 0, 360 ))
			particle:SetColor(255,100,100,255)
			particle:SetGravity( Vector(0,0,5) ) 
			particle:SetAirResistance(5)  
			particle:SetCollide(false)
			particle:SetBounce(100)
	...
	for i = 1,1 do
		...
		if (particle) then
			...
			particle:SetAngleVelocity( Angle(0,0,0) ) 
			particle:SetRoll(math.Rand( 0, 360 ))
			particle:SetColor(255,75,0,math.random(150,255))
			particle:SetGravity( Vector(0,0,5) ) 
			particle:SetAirResistance(5)  
			particle:SetCollide(false)
			particle:SetBounce(100)
