...
function EFFECT:Render()
	...
	if self.size>0.80 then
		render.DrawBeam( self.Startpos, self.Endpos, (1-self.size)*28.571, 0, 0.5, Color( 175, 255, 255, 255 ) ) 
	end
	if self.size<=0.80 and self.size>0.7 then
		render.DrawBeam( self.Startpos, self.Endpos, ((self.size))*7.128, 0, 0.5, Color( 175, 255, 255, 255 ) ) 
	end
	if self.size<=0.70 and self.size>=0.2 then
		render.DrawBeam( self.Startpos, self.Endpos, 5, 0, 0.5, Color( 175, 255, 255, 255 ) ) 
	end
	if self.size<0.2 then
		render.DrawBeam( self.Startpos, self.Endpos, self.size*50, 0, 0.5, Color( 175, 255, 255, 255 ) ) 
	end
end