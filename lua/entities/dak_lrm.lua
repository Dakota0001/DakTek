...
function ENT:Draw()
	...
	util.Effect("lrmtrail", effectdata)
...
function ENT:Initialize()
	...
	function ENT:Think()
		...
		self.RandomPos:Rotate(Angle(90,90,90))



		if(self.DakFireTime+1.0>CurTime()) then
