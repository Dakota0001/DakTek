...
if (CLIENT) then
	...
	--	print(500/LocalPlayer():GetPos():Distance(self:GetPos()))
	--	sound.Play( "dak/ballisticimpact.wav", LocalPlayer():GetPos()+((self:GetPos()-LocalPlayer():GetPos()):GetNormalized()*1000), 80, 80, math.Clamp(500/LocalPlayer():GetPos():Distance(self:GetPos()),0,1) )
	--end
end
...
function ENT:Initialize()
	...
	self.DakHealth=500
 	...
 	util.SpriteTrail( self, -1, Color(255,200,75,200), true, self.damage*3, self.damage, 0.05, 1 / ( self.damage*3 + self.damage ) * 0.5, "trails/smoke.vmt" )
end
