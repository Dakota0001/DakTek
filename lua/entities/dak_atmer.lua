...
function ENT:Initialize()
	...
	self.DakHealth=500
 	...
 	self.RanVec = Vector(math.Rand(-50,50),math.Rand(-50,50),math.Rand(-50,50))
	...
	function ENT:Think()
		...
		local Pitch = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).p,-250,250)
		local Yaw = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).y,-250,250)
		local Roll = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).r,-250,250)
