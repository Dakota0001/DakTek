...
ENT.PrintName = "SSRM Missile"

ENT.Spawnable = false
ENT.AdminOnly = false
--ENT.RenderGroup = RENDERGROUP_OPAQUE

util.PrecacheModel("models/dak/srmrocket.mdl")
ENT.DakGun = nil
ENT.DakTarget = nil
ENT.DakFireTime = 0
...
function ENT:Draw()
	...
	util.Effect("srmtrail", effectdata)
...
function ENT:Initialize()
	self:SetModel( "models/dak/srmrocket.mdl" )
...
function ENT:Think()
			...
			local Pitch = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).p,-150,150)
			local Yaw = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).y,-150,150)
			local Roll = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).r,-150,150)
