...
ENT.PrintName = "Standard ATM Missile"

ENT.Spawnable = false
ENT.AdminOnly = false
--ENT.RenderGroup = RENDERGROUP_OPAQUE

util.PrecacheModel("models/dak/atmrocket.mdl")
ENT.DakGun = nil
ENT.DakTarget = nil
ENT.DakFireTime = 0
...
function ENT:Draw()
	...
	util.Effect("atmtrail", effectdata)
...
function ENT:Initialize()
	self:SetModel( "models/dak/atmrocket.mdl" )
	...
	self.DakHealth=500
 	...
 	self.RanVec = Vector(math.Rand(-125,125),math.Rand(-125,125),math.Rand(-125,125))
 	self.RandomPos = Vector(math.Rand(-50,50),math.Rand(-50,50),math.Rand(-50,50))
	...
	function ENT:Think()
		...
		local Pitch = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).p,-125,125)
		local Yaw = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).y,-125,125)
		local Roll = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).r,-125,125)
