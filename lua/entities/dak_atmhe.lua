...
function ENT:Initialize()
	...
	self.DakHealth=500
 	...
 	self.RanVec = Vector(math.Rand(-175,175),math.Rand(-175,175),math.Rand(-175,175))
	...
	function ENT:Think()
		...
		local Pitch = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).p,-50,50)
		local Yaw = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).y,-50,50)
		local Roll = math.Clamp(self:WorldToLocalAngles((self.TargetPos+self.RandomPos-self:GetPos()):Angle()).r,-50,50)
